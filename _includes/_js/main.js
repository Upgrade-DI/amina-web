	...
	if(!isMobile)
		...
		$(document).ready(function() {
			...
			$(".card").click(function(){
				...
				// Alternar la clase 'active' para mostrar/ocultar contenido y cambiar estilos
				$(this).toggleClass('active');
				
				// Alternar el icono de la flecha
				if ($(this).hasClass('active')) {
					arrow.html("&#9650;"); // Cambia a flecha hacia arriba
				} else {
					arrow.html("&#9660;"); // Cambia a flecha hacia abajo
				}
			});

			$("#circle1").click(function() {
				$("#section-title").text("Optimización para Circle 1");
				$("#section-subtitle").text("Escenarios y ofertas para Circle 1");
				$("#section-content").text("Contenido específico para Circle 1 sobre compraventa de productos de energía (PPA) y objetivos de sostenibilidad.");
				$(".text-content").addClass("active");
			});
		
			$("#circle2").click(function() {
				$("#section-title").text("Optimización para Circle 2");
				$("#section-subtitle").text("Escenarios y ofertas para Circle 2");
